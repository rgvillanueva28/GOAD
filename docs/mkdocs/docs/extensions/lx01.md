...
- Extension name : `lx01`
- Description : Add a linux ubuntu 22.4 to the lab GOAD or GOAD Light in the domain ptolabs.local
- Compatibility  : GOAD / GOAD-Light /Goad-Mini 
- Providers : virtualbox/azure/vmware/aws/ludus

- Add a machine  : {{lab_name}}-LX01 (dragonstone.ptolabs.local)  (ip_range.32)
